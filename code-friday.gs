// ============================================================
// HACKERS CUP — Google Apps Script Backend (FRIDAY)
// Spreadsheet: https://docs.google.com/spreadsheets/d/12xsABHNgKFeQkbzxWiBeW02sdHftojQdwlDhVfp2PUI/edit
// Deploy as: Web App -> Execute as: Me -> Who has access: Anyone
// ============================================================

const SPREADSHEET_ID = '12xsABHNgKFeQkbzxWiBeW02sdHftojQdwlDhVfp2PUI';
...
const LB_GID = 1388834412;      // "Leaderboard" tab
const LB_HCAP_GID = 1040982204; // "Players" tab (name + handicap)
